...
HIERARCHIES = {
    'AI': dict(
        ...
        labels = [
            "Artistic<br>Intention","Context","Audience","Intervention<br>Visibility",
            "Visitor\'s<br>Position","Lifespan","Sound<br>Design","Lighting<br>Design",
            "Role of<br>Sound","Material","Process","Dynamic",
            # leaves (assigned in CSV column order):
            "Exhibition","Outdoor","Indoor","School","Prototype","Transportation","Care<br>Center",
            "Adults","Children","Both",
            "Non<br>Visible","Non-Sonic<br>Elements","Visual<br>interface","Sonic<br>Elements",
            "Pathway","No Specific<br>Path","Sweet<br>Spot",
            "Ephemeral","Semi-Permanent","Permanent",
            "Abstract","Referential","Local<br>Recordings","Infrasounds",
            "Pre-existing<br>Material","Sonification","Feedback<br>Generated",
            "Auto-Generated","Noise<br>Cancellation","Site's Acoustics<br>Involved",
            "No<br>Lighting","Static Lights","Dynamic ",
            "Expressive","Informational","Didactic","Therapeutic",
        ],
    ),
    'SD': dict(
        ids = ["SyD","TS","SP","SG",
               "TS_Ele","TS_Mec","TS_Ide","TS_Mic","TS_Ima","TS_Bio","TS_Con","TS_Det","TS_Env",
               "SP_Num","SP_Hea","SP_Pnt","SP_Cnt","SP_Dir","SG_Obj"],
        parents = ["","SyD","SyD","SyD",
                   "TS","TS","TS","TS","TS","TS","TS","TS","TS",
                   "SP","SP","SP","SP","SP","SG"],
        subs = ["TS_Ele","TS_Mec","TS_Ide","TS_Mic","TS_Ima","TS_Bio","TS_Con","TS_Det","TS_Env",
                "SP_Num","SP_Hea","SP_Pnt","SP_Cnt","SP_Dir","SG_Obj"],
        labels = [
            "System<br>Design","Type of<br>Input Device","Spatialization","Sound<br>Generation",
            "Electric,<br>Magnetic Sensors","Force and<br>Pressure Sensors","Identification",
            "Microphones","Image<br>Sensors","Bio-signals<br>Sensors","Controllers",
            ...
            "Pressure<br>Pad","Proximity<br>Sensor","Light<br>Sensor","Heat<br>Sensor",
            "Wind<br>Sensor","Seismograph",
            "One   ","Two   ","Multiple<br>Sources","Stereo","Towards the<br>Same Point",
            "Towards<br>Different Points","Dynamic  ","Channel-Based",
            "Automated<br>Spatialization","Directive","Non<br>Directive",
    ...
    'IN': dict(
        ...
        subs = ["IT_Use","IT_Ada"],
        labels = [
            "Interaction","Inter-Actors","Input Degrees<br>Of Freedom",
            "Output Degrees<br>Of Freedom","Feedback<br>Type","Musical<br>Control",
            "Interaction<br>Type","User<br>Interaction","Adaptive",
            # leaves:
            "Many","Few","One","Countless","None",
            "One  ","Two ","Three or<br>More ","One ","Two","Three or<br>More",
            "Visual","Haptic","Auditory","Heat","Taste","Smell",
            "Process","Note-Level","Timbral",
            "Global<br>Activity","Network","Embodied","Visitor\'s<br>Motion",
            "Visitor\'s<br>Sounds","Eyes\'<br>Movements","Facial<br>Expression",
            "Brain<br>Activity","Natural<br>Elements",
        ],
    ),
}
